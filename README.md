...
**Total: 31 test files, 601 test cases.**
...
| **Test** | `npm test --coverage`, then a second serial run (Jest, 601 tests across 31 suites) |
...
npm test          # Jest (601 tests across 31 suites)
