...
| InboxSDK for route detection | Intended to provide Gmail-aware routing and user identity | ✓ Removed after v1.6.2. It never ran: its page world needs the `scripting` permission we do not declare. The content script fell from 1,103,251 to 72,159 bytes with no behaviour change. See ADR-021 |
