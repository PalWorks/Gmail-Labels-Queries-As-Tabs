...
**Total: 30 test files, 580 test cases.**
...
| **Test** | `npm test --coverage`, then a second serial run (Jest, 580 tests across 30 suites) |
...
npm test          # Jest (580 tests across 30 suites)
