...
**Total: 35 test files, 701 test cases.**
...
| **Test** | `npm test --coverage`, then a second serial run (Jest, 701 tests across 35 suites) |
...
npm test          # Jest (701 tests across 35 suites)
