...
**Total: 35 test files, 708 test cases.**
...
| **Test** | `npm test --coverage`, then a second serial run (Jest, 708 tests across 35 suites) |
...
npm test          # Jest (708 tests across 35 suites)
