...
**Total: 30 test files, 589 test cases.**
...
| **Test** | `npm test --coverage`, then a second serial run (Jest, 589 tests across 30 suites) |
...
npm test          # Jest (589 tests across 30 suites)
